...
||||||| parent of 4ef998ee0... Don't fail configure.ps1 when errors are handled correctly (#4409)
            $channelMainVersion = ""
...
>>>>>>> 4ef998ee0... Don't fail configure.ps1 when errors are handled correctly (#4409)
        }
